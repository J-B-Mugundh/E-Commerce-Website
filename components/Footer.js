...
export default function Footer(){
  ...
  console.log({path})
  return(
    <footer className="sticky bottom-0 bg-white p-5 flex w-full border-t border-gray-200 justify-center items-center space-x-12 text-gray-400">
      <Link href={'/'}>
      {/* Getting JSX from heroicons.com */}
